...
<div class="center">
    ...
    <div class="container">
        <form action= '<?php echo $_SERVER['PHP_SELF']; ?>' method='POST'>
            ...
            <!--Vérification que l'adresse mail a l'air valide-->
            ...
            <!--Crée utilisateur dans la base de données avec rôle reader par défaut et envoie mail à administrateur pour prévenir qu'il y a un nouveau utilisateur avec le rôle voulu-->
        </form>
        <?php
